...
| value | OutputData                                                                         | data when using editor js as [controlled component](https://reactjs.org/docs/forms.html#controlled-components). <br> ⚠️ Don't use it with onChange prop. Infinite loops can occur.                                                                                                         |
